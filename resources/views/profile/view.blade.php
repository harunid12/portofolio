                  ...
                  <div class="active tab-pane" id="settings">
                    <form action="/profile-update/{{ $profile->username }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="file" class="dropify" name="image" data-height="150" data-default-file="{{ asset('storage/users/'.$profile->image) }}" data-width="100" data-max-file-size="1M">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">Username</label>
                        <div class="col-sm-10">
                          <input type="text" name="username" value="{{ $profile->username }}" class="form-control" id="username" placeholder="Name" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
